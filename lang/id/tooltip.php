...
return [
    ...
    */
    ...
    'payment_dues' => "Pembayaran tertunda untuk pembelian. <br/><small class='text-muted'>Berdasarkan jangka waktu pembayaran Supplier. <br/> Menampilkan pembayaran yang harus dibayar dalam 7 hari atau kurang.</small>",
    ...
    'top_trending_products' => "Produk terlaris dari toko Anda. <br/><small class='text-muted'>Terapkan filter untuk mengetahui produk terlaris dalam Kategori, Merek, Cabang Bisnis dll.</small>",
    ...
    'purchase_location' => 'Cabang Bisnis dimana tempat produk yang dibeli akan tersedia untuk dijual.',

    'sale_location' => 'Cabang Bisnis dari tempat Anda ingin menjual',
    ...
    'invoice_scheme' => "Skema Faktur juga format penomoran faktur. Pilih skema yang akan digunakan untuk Cabang Bisnis ini<br><small class='text-muted'><i>Anda dapat menambahkan Skema Faktur baru </b> di Pengaturan Faktur</i></small>",

    'invoice_layout' => "Tata Letak Faktur yang akan digunakan untuk Cabang Bisnis ini<br><small class='text-muted'>(<i>Anda dapat menambahkan <b> Tata Letak Faktur </b> baru di <b> Pengaturan Faktur<b></i>)</small>",
    ...
    'all_location_permission' => 'Jika <b> Semua Lokasi </b> dipilih, peran ini akan memiliki izin untuk mengakses semua Cabang Bisnis',
