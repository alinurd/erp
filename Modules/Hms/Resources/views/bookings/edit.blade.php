                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            ...
                            <strong class="display_currency total_discount" data-currency_symbol="true">0.00</strong>
    ...
    <script>
        $(document).ready(function() {
            ...
            async function calculateAllPrice() {
                    ...
                    $('.total_discount').text(__currency_trans_from_en(total_discount.toFixed(2) , true));
            }
